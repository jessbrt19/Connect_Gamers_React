      ...
      <div className={`container mx-auto px-4 pt-24 pb-16 max-w-4xl ${
        ...
        <div className="text-center mb-12">
          <div className="relative inline-block">
            {/* Área interna do círculo com cor diferente */}
            <div className="w-44 h-44 rounded-full border-4 border-[rgb(253,77,121)] shadow-lg mx-auto flex items-center justify-center overflow-hidden" 
                 style={{ backgroundColor: darkTheme ? '#3a3a4a' : '#f0f0f5' }}>
              <img
                src={profileImage}
                alt="Foto do perfil"
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              ...
              <div className={`p-5 rounded-lg shadow-md transition-all hover:shadow-lg ${
                ...
                <h3 className={`font-bold text-lg ${
                  darkTheme ? 'text-gray-100' : 'text-gray-800'
                }`}>Campeonato de League of Legends</h3>
                <div className="flex items-center mt-2">
                  <i className={`fas fa-calendar-day mr-2 ${
                    darkTheme ? 'text-gray-400' : 'text-gray-600'
                  }`}></i>
